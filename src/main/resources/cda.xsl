...
<xsl:stylesheet version="1.0"
        ...
        xmlns:n1="urn:hl7-org:v3" xmlns:npfitlc="NPFIT:HL7:Localisation"
        xmlns:n2="urn:hl7-org:v3/meta/voc"
        xmlns:voc="urn:hl7-org:v3/voc"
        xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        exclude-result-prefixes="n1 n2 voc npfitlc xsi">
        ...
        <xsl:variable name="title">
                <xsl:choose>
                        <xsl:when
                                test="/n1:ClinicalDocument/n1:title">
                                <xsl:value-of
                ...
                <html>
                        <head>
                                <xsl:comment>
                                        ...
                                        $updateDate=21/11/2012
                                        Interoperability Team
                                </xsl:comment>
                                <!-- <meta name='Generator' content='&CDA-Stylesheet;'/> -->
                                <xsl:comment>
                                        Do NOT edit this HTML directly,
                                        it was generated via an XSLT
...
.b1 {
        ...
        font-weight: bold;
                        ...
                        <xsl:comment>
                                Derived from HL7 Finland R2
                                Tyylitiedosto: Tyyli_R2_B3_01.xslt
                        </xsl:comment>
                        <xsl:comment>
                                Updated by Calvin E. Beebe, Mayo Clinic
                                - Rochester Mn.
                        </xsl:comment>
                        <xsl:comment>
                                Updated by Keith W. Boone, Dictaphone -
                                Burlington, MA
                        </xsl:comment>
                        <xsl:comment>Updated
                                by Kai U. Heitmann, Heitmann Consulting
                                &amp; Service, NL for VHitG, Germany
                        </xsl:comment>
                        <xsl:comment>
                                Updated by Rene Spronk, translate back
                                to english-language labels
                        </xsl:comment>
                        <xsl:comment>
                                Updated by Dick Donker, Philips Medical
                                Systems include linkHtml
                        </xsl:comment>
                        <xsl:comment>
                                Updated by Tim Pilkington - NHS CFH
                        </xsl:comment>
                        <xsl:comment>
                                Updated by Aled Greenhalgh - NHS CFH
                        </xsl:comment>
                        <xsl:comment>
                                Updated by Prashant Trivedi - NHS CFH
                        </xsl:comment>
                        <body>
                                <div
                                        style="color:red; font-weight:bold;">***This HTML is created
                                        using transform which is
                                        provided on as-is basis and
                                        content of this HTML is not
                                        clinically validated. The
                                        transform used to create this
                                        HTML can be modified as per
                                        local needs.***</div>
                                <xsl:call-template
                                        name="patientBanner" />
                                <xsl:if
                                        test="/n1:ClinicalDocument/n1:informant/n1:relatedEntity/n1:relatedPerson/n1:name">
                                        <xsl:call-template
                                                name="informantBanner" />
                                        <!--PRTR1 This banner should appears 
                                                if informant is present -->
                                </xsl:if>
                                <xsl:call-template
                                        name="header" />
                                <xsl:call-template
                                        name="titlebar" />
                                <xsl:if
                                        test="/n1:ClinicalDocument/n1:participant">
                                        <xsl:call-template
                                                name="participantBanner" />
                                        <!--PRTR1 This banner should appears 
                                                if participant is present -->
                                </xsl:if>
                                <xsl:apply-templates
                ...
                <xsl:choose>
                        <xsl:when test="$name/n1:family">
                                <xsl:if test="$name/n1:prefix">
                                        <xsl:value-of
                                                select="$name/n1:prefix" />
                                        <xsl:text> </xsl:text>
                                </xsl:if>
                                <xsl:value-of
                                        select="$name/n1:given" />
                                <xsl:text> </xsl:text>
                                <xsl:value-of
                                        select="$name/n1:family" />
                                <xsl:if test="$name/n1:suffix">
                                        <xsl:text> </xsl:text>
                                        <xsl:value-of
                                                select="$name/n1:suffix" />
                                </xsl:if>
                        </xsl:when>
                        <xsl:otherwise>
                                <xsl:value-of
        ...
        <xsl:template name="cuiName">
                ...
                <xsl:choose>
                        <xsl:when test="$name/n1:family">
                                <xsl:value-of
                                        select="translate($name/n1:family, $smallcase, $uppercase)" />
                                <xsl:text>, </xsl:text>
                                <xsl:value-of
                                        select="$name/n1:given" />
                                <xsl:if test="$name/n1:suffix">
        ...
        <xsl:template name="cuiNHSNo">
                ...
                <xsl:value-of
                        select="substring($nhsNo, 1, 3)" />
                <xsl:text> </xsl:text>
                <xsl:value-of
                        select="substring($nhsNo, 4, 3)" />
                <xsl:text> </xsl:text>
        ...
        <xsl:template match="n1:component/n1:nonXMLBody">
                <xsl:choose>
                        ...
                        <xsl:when test="n1:text/n1:reference">
                                <IFRAME name="nonXMLBody"
                                        id="nonXMLBody" WIDTH="100%"
                                        HEIGHT="66%"
                                        src="{n1:text/n1:reference/@value}" />
                        </xsl:when>
                        <xsl:when
                                test="n1:text/@mediaType='text/plain'">
                                <pre>
                                        <xsl:value-of
                                                select="n1:text/text()" />
                                </pre>
        ...
        <!-- StructuredBody -->
        <xsl:template
                match="n1:component/n1:structuredBody">
                <xsl:apply-templates
                        select="n1:component/n1:section" />
                <xsl:if test="$debug='yes'">
                        <hr />
                        <h1>Coded Entries</h1>
                        <xsl:for-each select="//n1:entry">
                                <xsl:call-template
                                        name="CodedEntryMatch">
                                        <xsl:with-param
                                                name="temp_1" select="." />
                                </xsl:call-template>
                        </xsl:for-each>
                        <xsl:for-each
                                select="//n1:entryRelationship">
                                <xsl:call-template
                                        name="CodedEntryMatch">
                                        <xsl:with-param
                                                name="temp_1" select="." />
        ...
        <xsl:template name="CodedEntryMatch">
                ...
                <xsl:variable name="v_codedentry"
                        select="$temp_1/child::node()[child::n1:templateId[contains(@extension,'146')]]" />
                <xsl:if
                        test="$v_codedentry/n1:code | $v_codedentry/n1:value ">
                        <p>
                                <xsl:value-of
                                        select="substring-after($v_codedentry/n1:templateId/@extension,'#')" />
                                -
                                <xsl:value-of
                                        select="substring-before($v_codedentry/n1:templateId/@extension,'#')" />
                        </p>
                        <p>
                                Code :
                                <xsl:value-of
                                        select="$v_codedentry/n1:code/@code" />
                        </p>
                        <p>
                                Displayname :
                                <xsl:value-of
                                        select="$v_codedentry/n1:code/@displayName" />
                        </p>
                        <xsl:if
                                test="$v_codedentry/n1:value/@code">
                                <p>
                                        Value Code :
                                        <xsl:value-of
                                                select="$v_codedentry/n1:value/@code" />
                                </p>
                                <p>
                                        Value Displayname :
                                        <xsl:value-of
                                                select="$v_codedentry/n1:value/@displayName" />
                                </p>
                        </xsl:if>
                        <xsl:if
                                test="$v_codedentry/n1:value/@value">
                                <p>
                                        Value :
                                        <xsl:value-of
                                                select="$v_codedentry/n1:value/@value" />
                                        <xsl:if
                                                test="$v_codedentry/n1:value/@unit">
                                                -
                                                <xsl:value-of
                                                        select="$v_codedentry/n1:value/@unit" />
                                        </xsl:if>
                                </p>
                        </xsl:if>
                        <xsl:for-each
                                select="$v_codedentry/n1:code/n1:qualifier">
                                <p>qualifier</p>
                                <p>name
                                        code=&quot;
                                        <xsl:value-of
                                        ...
                                        &quot; displayName=&quot;
                                        <xsl:value-of
                                                select="n1:name/@displayName" />
                                        &quot;
                                </p>
                                <p>value
                                        code=&quot;
                                        <xsl:value-of
                                                select="n1:value/@code" />
                                        &quot; displayName=&quot;
                                        <xsl:value-of
                                                select="n1:value/@displayName" />
                                        &quot;
                                </p>
                        </xsl:for-each>
                        <xsl:if
                                test="$v_codedentry/n1:code/n1:originalText/n1:reference">
                                <p>
                                        Code Reference :
                                        <xsl:choose>
                                                <xsl:when
                                                        test="contains($v_codedentry/n1:code/n1:originalText/n1:reference/@value,'#')">
                                                        <a>
                                                                <xsl:attribute
                                                                        name="id"><xsl:value-of
                                                                        select="substring-after($v_codedentry/n1:code/n1:originalText/n1:reference/@value,'#')" /></xsl:attribute>
                                                                <xsl:value-of
                                                                        select="$v_codedentry/n1:code/n1:originalText/n1:reference/@value" />
                                                        </a>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                        <xsl:value-of
                        ...
                        <xsl:if
                                test="$v_codedentry/n1:value/n1:originalText/n1:reference">
                                <p>
                                        Value Reference :
                                        <xsl:choose>
                                                <xsl:when
                                                        test="contains($v_codedentry/n1:value/n1:originalText/n1:reference/@value,'#')">
                                                        <a>
                                                                <xsl:attribute
                                                                        name="id"><xsl:value-of
                                                                        select="substring-after($v_codedentry/n1:value/n1:originalText/n1:reference/@value,'#')" /></xsl:attribute>
                                                                <xsl:value-of
                                                                        select="$v_codedentry/n1:value/n1:originalText/n1:reference/@value" />
                                                        </a>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                        <xsl:value-of
                        ...
                        <xsl:if
                                test="$v_codedentry/n1:statusCode/@code">
                                <p>
                                        Status:
                                        <xsl:value-of
                                                select="$v_codedentry/n1:statusCode/@code" />
                                </p>
                        </xsl:if>
                        <xsl:if
                                test="$v_codedentry/n1:effectiveTime">
                                <p>
                                        Time:
                                        <xsl:if
                                                test="$v_codedentry/n1:effectiveTime/n1:low/@value">
                                                <xsl:call-template
                                                        name="formatDate">
                                                        <xsl:with-param
                                                                name="date"
                                                                select="$v_codedentry/n1:effectiveTime/n1:low/@value" />
                                                </xsl:call-template>
                                        </xsl:if>
                                        <xsl:if
                                                test="$v_codedentry/n1:effectiveTime/n1:high/@value">
                                                <xsl:text> to </xsl:text>
                                                <xsl:call-template
                                                        name="formatDate">
                                                        <xsl:with-param
                                                                name="date"
                                                                select="$v_codedentry/n1:effectiveTime/n1:high/@value" />
                                                </xsl:call-template>
                                        </xsl:if>
                                        <xsl:if
                                                test="$v_codedentry//n1:effectiveTime/n1:center/@value">
                                                <xsl:call-template
                                                        name="formatDate">
                                                        <xsl:with-param
                                                                name="date"
                                                                select="$v_codedentry/n1:effectiveTime/n1:center/@value" />
                                                </xsl:call-template>
                                        </xsl:if>
                                        <xsl:if
                                                test="$v_codedentry//n1:effectiveTime/@value">
                                                <xsl:call-template
                                                        name="formatDate">
                                                        <xsl:with-param
                                                                name="date"
                                                                select="$v_codedentry/n1:effectiveTime/@value" />
                                                </xsl:call-template>
                                        </xsl:if>
                                </p>
                        </xsl:if>
        ...
        <xsl:template name="RenderSectionCode">
                ...
                <xsl:if
                        test="$debug='yes' and $p_title/../n1:code/@code">
                        <font color="red">
                                <xsl:text>  [code=&quot;</xsl:text>
                                <xsl:value-of
                                        select="$p_title/../n1:code/@code" />
                                <xsl:text>&quot;]</xsl:text>
                        </font>
                </xsl:if>
        </xsl:template>
        ...
        <xsl:template match="n1:title">
                ...
                <xsl:variable name="sectionNestingLevel"
                        select="count($v_current/ancestor::n1:section)" />
                <xsl:choose>
                        <xsl:when
                                test="contains($v_current/../n1:templateId/@extension,'Section1') or $sectionNestingLevel = 1">
                                <h1>
                                        <!--Only when author is not present 
                                                at this level else hr will come via author PRTR1 -->
                                        <xsl:if
                                                test="not($v_current/../n1:author)">
                                                <hr />
                                        </xsl:if>
                                        <xsl:value-of
                                                select="$v_current" />
                                        <xsl:call-template
                                                name="RenderSectionCode">
                                                <xsl:with-param
                                                        name="p_title"
                                                        select="$v_current" />
                                        </xsl:call-template>
                        ...
                        <xsl:when
                                test="contains($v_current/../n1:templateId/@extension,'section2') or  contains($v_current/../n1:templateId/@extension,'Section2')or $sectionNestingLevel = 2 ">
                                <h2>
                                        <xsl:value-of
                                                select="$v_current" />
                                        <xsl:call-template
                        ...
                        <xsl:when
                                test="contains($v_current/../n1:templateId/@extension,'section3') or contains($v_current/../n1:templateId/@extension,'Section3') or $sectionNestingLevel = 3 ">
                                <h3>
                                        <xsl:value-of
                                                select="$v_current" />
                                        <xsl:call-template
                        ...
                        <xsl:when
                                test="contains($v_current/../n1:templateId/@extension,'section4') or $sectionNestingLevel = 4 ">
                                <h4>
                                        <xsl:value-of
                                                select="$v_current" />
                                        <xsl:call-template
                        ...
                        <xsl:when
                                test="contains($v_current/../n1:templateId/@extension,'section5') or $sectionNestingLevel = 5 ">
                                <h5>
                                        <xsl:value-of
                                                select="$v_current" />
                                        <xsl:call-template
                        ...
                        <xsl:when
                                test="contains($v_current/../n1:templateId/@extension,'section6') or $sectionNestingLevel = 6  ">
                                <h6>
                                        <xsl:value-of
                                                select="$v_current" />
                                        <xsl:call-template
                        ...
                        <table class="textsection">
                                <tr>
                                        ...
                                        <td class="textsection">
                                                <xsl:choose>
                                                        <xsl:when
                                                                test="$v_current/n1:assignedAuthor/n1:assignedPerson/n1:name">
                                                                <xsl:call-template
                                                                        name="getName">
                                                                        <xsl:with-param name="name"
                                                                                select="$v_current/n1:assignedAuthor/n1:assignedPerson/n1:name" />
                                                                </xsl:call-template>
                                                                <xsl:if
                                                                        test="$v_current/n1:assignedAuthor/n1:code/@displayName">
                                                                        <xsl:text> - </xsl:text>
                                                                        <xsl:value-of
                                                                                select="$v_current/n1:assignedAuthor/n1:code/@displayName" />
                                                                </xsl:if>
                                                                <xsl:if
                                                                        test="$v_current/n1:assignedAuthor/n1:representedOrganization/n1:name">
                                                                        <xsl:text>, </xsl:text>
                                                                        <xsl:value-of
                                                                                select="$v_current/n1:assignedAuthor/n1:representedOrganization/n1:name" />
                                                                </xsl:if>
                                                        </xsl:when>
                                                        <xsl:when
                                                                test="$v_current/n1:assignedAuthor/n1:assignedAuthoringDevice/n1:manufacturerModelName">
                                                                <xsl:value-of
                                                                        select="$v_current/n1:assignedAuthor/n1:assignedAuthoringDevice/n1:manufacturerModelName" />
                                                                <xsl:if
                                                                        test="$v_current/n1:assignedAuthor/n1:representedOrganization/n1:name">
                                                ...
                                                <xsl:call-template
                                                        ...
                                                        <xsl:with-param
                                                                name="date"
                                                                select="$v_current/n1:time/@value" />
                                                </xsl:call-template>
                                        </td>
                                </tr>
                        </table>
        ...
        <xsl:template match="n1:linkHtml">
                <xsl:element name="a">
                        ...
                        <xsl:apply-templates />
                        <!--<xsl:for-each select="l@*"> <xsl:if test="not(name()=&quot;originator&quot; 
                                or name()=&quot;confidentiality&quot;)"> <xsl:attribute name="{name()}"> 
        ...
        <xsl:template name="render_content">
                ...
                <p>
                        <xsl:choose>
                                <xsl:when
                                        test="$p_doc//descendant::n1:reference[contains(@value,$p_ID)]">
                                        <a>
                                                <xsl:attribute
                                                        name="href"><xsl:value-of
                                                        select="concat('#',$p_ID)" /></xsl:attribute>
                                                <b>
                                                        <font
                                                                color="red">
                                                                <xsl:value-of
                ...
                <p>
                        <xsl:if test="@styleCode">
                                <xsl:attribute
                                        ...
                                        select="@styleCode" /></xsl:attribute>
                        </xsl:if>
                        <xsl:apply-templates />
                </p>
        </xsl:template>
        ...
        <!-- Tables -->
        <xsl:variable name="debugRowLabelWidth">
                150px
        </xsl:variable>
        <xsl:template match="n1:table">
                <table>
                        <xsl:if
                                test="$debug='yes' and count(descendant::n1:tr[@ID]|child::n1:thead[@ID]|child::n1:tfoot[@ID]|child::n1:tbody[@ID]|child::n1:thead[@ID]) > 0">
                                <xsl:attribute
                                        name="style">margin-left: <xsl:value-of
                                        select="$debugRowLabelWidth" />;</xsl:attribute>
                        </xsl:if>
                        <xsl:copy-of select="@*" />
                        <xsl:apply-templates />
                </table>
        ...
        <xsl:template match="n1:tr">
                <tr>
                        ...
                        <xsl:if test="$debug='yes'">
                                <xsl:attribute
                                        name="style">position:relative;</xsl:attribute>
                        </xsl:if>
                        <xsl:apply-templates />
                </tr>
        </xsl:template>
        <xsl:template match="n1:th">
                <th>
                        ...
                        <xsl:if test="not(@align)">
                                <xsl:attribute
                                        name="class">default</xsl:attribute>
                        </xsl:if>
                        <xsl:if
                                test="$debug='yes' and position() = 1">
                                <xsl:call-template
                                        name="RenderRowDebugLabel" />
                        </xsl:if>
                        <xsl:apply-templates />
                </th>
        </xsl:template>
                ...
                <xsl:if test="ancestor::n1:*[@ID]">
                        <div style="position: relative;">
                                <div>
                                        <xsl:attribute
                                                name="style">
						position:absolute; left: -<xsl:value-of
                                                select="$debugRowLabelWidth" />;
						color: red; font-weight: bold;
					</xsl:attribute>
                                        <xsl:value-of
                                                select="ancestor::n1:*/@ID" />
                                </div>
                        </div>
                </xsl:if>
        </xsl:template>
        <!-- RenderMultiMedia this currently only handles GIF's and JPEG's. 
                It could, however, be extended by including other image MIME types in the 
                predicate and/or by generating <object> or <applet> tag with the correct 
        ...
        <xsl:template match="n1:renderMultiMedia">
                ...
                <xsl:choose>
                        <xsl:when
                                test="//n1:regionOfInterest[@ID=$imageRef]">
                                <!-- Here is where the Region of Interest 
                                        image referencing goes -->
                                <xsl:if
          ...
          @mediaType='image/jpeg']">
                        ...
                        <xsl:otherwise>
                                <!-- Here is where the direct MultiMedia 
                                        image referencing goes -->
                                <xsl:if
                ...
                <div id="patientBanner" class="banner">
                        <table>
                                <tbody>
                                        <tr>
                                                <xsl:if
                                                        test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:name">
                                                        <td>
                                                                <xsl:call-template
                                                                        name="cuiName">
                                                                        <xsl:with-param name="name"
                                        ...
                                        <tr>
                                                <xsl:if
                                                        test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:birthTime">
                                                        <td>
                                                                <span
                                                                        class="label">
                                                                        Born
                                        ...
                                        <tr>
                                                <xsl:if
                                                        test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:administrativeGenderCode">
                                                        <td>
                                                                <span
                                                                        class="label">
                                                                        Gender
                                        ...
                                        <tr>
                                                <td>
                                                        <xsl:if
                                                                test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id/@root='2.16.840.1.113883.2.1.4.1'">
                                                                <!-- Verified 
                                                                        NHS Number -->
                                                                <span
                                                                        class="label">
                                                                ...
                                                                <xsl:call-template
                                                                        ...
                                                                        <xsl:with-param name="nhsNo"
                                                                                select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id[@root='2.16.840.1.113883.2.1.4.1']/@extension" />
                                                                </xsl:call-template>
                                                                <br />
                                                        </xsl:if>
                                                </td>
                                        ...
                                        <tr>
                                                <td>
                                                        <xsl:if
                                                                test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id/@root='2.16.840.1.113883.2.1.3.2.4.18.23'">
                                                                <!-- Unverified 
                                                                        NHS Number -->
                                                                <span
                                                                        class="label">
                                        ...
                                        <tr>
                                                <td>
                                                        <xsl:for-each
                                                                select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']">
                                                                <!-- Local 
                                                                        ID -->
                                                                <span
                                                                        class="label">
                                                                ...
                                                                <xsl:value-of
                                                                        select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']/@extension" />
                                                                <br />
                                                        </xsl:for-each>
                                                </td>
                                        </tr>
                                        <!--<xsl:for-each select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:languageCommunication"> 
                                                <tr> <td> <span class="label"> Patient's Language </span> <xsl:call-template 
                                                name="translateLanguageCode"> <xsl:with-param name="languageCode" select="./n1:languageCode/@code"/> 
                                                </xsl:call-template> <xsl:if test="./n1:proficiencyLevelCode"> <xsl:text> 
                                                (</xsl:text> <xsl:value-of select="./n1:proficiencyLevelCode/@displayName"/> 
                                                <xsl:text>)</xsl:text> </xsl:if> </td> </tr> </xsl:for-each> -->
                                        <xsl:if
                                                test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:languageCommunication">
                                                <tr>
                                                        <td>
                                                                <p
                                                                        class="label">
                                                                ...
                                                                <xsl:for-each
                                                                        select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:languageCommunication">
                                                                        <p>
                                                                                <xsl:call-template name="translateLanguageCode">
                                                                                        <xsl:with-param name="languageCode"
                                                                                                select="./n1:languageCode/@code" />
                                                                                </xsl:call-template>
                                                                                <xsl:if test="./n1:proficiencyLevelCode">
                                                                                        <xsl:text> (</xsl:text>
                                                                                        <xsl:value-of
                                                                                                select="./n1:proficiencyLevelCode/@displayName" />
                                                                                        <xsl:text>)</xsl:text>
                                                                                </xsl:if>
                                                                        </p>
                                                                </xsl:for-each>
                        ...
                        <table class="header">
                                <tbody>
                                        <tr>
                                                <xsl:for-each
                                                        select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:addr">
                                                        <td>
                                                                <p
                                                                        class="label">
                                                                        <xsl:choose>
                                                                                ...
                                                                                <xsl:when test="@use='DIR'">
                                                                                        Direct
                                                                                        Address
                                                                                </xsl:when>
                                                                                <xsl:when test="@use='PUB'">
                                                                                        Public
                                                                                        Address
                                                                                </xsl:when>
                                                                                <xsl:when test="@use='BAD'">
                                                                                        Bad
                                                                                        Address
                                                                                </xsl:when>
                                                        ...
                                                        <xsl:for-each
                                                                ...
                                                                <span
                                                                        ...
                                                                        <xsl:choose>
                                                                                ...
                                                                                <xsl:when test="@use='AS'">
                                                                                        Answer
                                                                                </xsl:when>
                                                                                <xsl:when test="@use='EC'">
                                                                                        Emergency
                                                                                </xsl:when>
                                                                                <xsl:when test="@use='MC'">
                                                                                        Mobile
                                                                                </xsl:when>
                                                                                <xsl:when test="@use='PG'">
                                                                                        Pager
                                                                                </xsl:when>
                                                                                <xsl:otherwise />
                                                                        </xsl:choose>
                                                                        <xsl:choose>
                                                                                ...
                                                                                <xsl:when test="contains(@value, 'tty')">
                                                                                        Textphone
                                                                                </xsl:when>
                                                                                <xsl:when test="contains(@value, 'sms')">
                                                                                        SMS
                                                                                </xsl:when>
                                                                                <xsl:when test="contains(@value, 'voice')">
                                                                                        Voice
                                                                                </xsl:when>
                                                                                <xsl:otherwise />
                                                                        </xsl:choose>
                                        ...
                                        <tr>
                                                <xsl:if
                                                        test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization">
                                                        <td>
                                                                <p
                                                                        class="label">
                                                                        <xsl:value-of
                                                                                select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization/n1:standardIndustryClassCode/@displayName" />
                                                                </p>
                                                                <p>
                                                                        <xsl:value-of
                                                                                select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization/n1:name" />
                                                                        <xsl:for-each
                                                                                select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization/n1:addr/n1:*">
                                                                                <br />
                                                                                <xsl:value-of select="." />
                                                                        </xsl:for-each>
                                                                </p>
                                                                <xsl:for-each
                                                                        select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization/n1:telecom">
                                                                        <p>
                                                                                <span class="label">
                                                                                        <xsl:choose>
                                                                                                <xsl:when test="contains(@value, 'mailto')">
                ...
                <div id="informantBanner" class="banner">
                                                ...
                                                <xsl:if
                                                        ...
                                                        <td>
                                                                <xsl:call-template
                                                                        name="getName">
                                                                        <xsl:with-param name="name"
                                                                                select="/n1:ClinicalDocument/n1:informant/n1:relatedEntity/n1:relatedPerson/n1:name" />
                                                                </xsl:call-template>
                                                                <!--PRTR1 
                                                                        Get display name as well here -->
                                                                <xsl:if
                                                                        test="/n1:ClinicalDocument/n1:informant/n1:relatedEntity/n1:code/@displayName">
                                                                        <xsl:text> - </xsl:text>
                                                                        <xsl:value-of
                                                                                select="/n1:ClinicalDocument/n1:informant/n1:relatedEntity/n1:code/@displayName" />
                                                                </xsl:if>
                                                        </td>
                                                </xsl:if>
                                        </tr>
                        ...
                        <table class="header">
                                <tbody>
                                        <tr>
                                                <xsl:for-each
                                                        select="/n1:ClinicalDocument/n1:informant/n1:relatedEntity/n1:addr">
                                                        <td>
                                                                <p
                                                                        class="label">
                                                                        <xsl:choose>
                                                ...
                                                <td>
                                                        <xsl:for-each
                                                                select="/n1:ClinicalDocument/n1:informant/n1:relatedEntity/n1:telecom">
                                                                <span
                                                                        class="label">
                                                                        <xsl:choose>
                                                                                <xsl:when test="@use='H'">
        ...
        <xsl:template name="header">
                <div class="header">
                        <table class="header">
                                ...
                                <xsl:for-each
                                        ...
                                        <tr>
                                                ...
                                                <td class="header">
                                                        <xsl:choose>
                                                                <xsl:when
                                                                        test="n1:assignedAuthor/n1:assignedPerson/n1:name">
                                                                        ...
                                                                        <xsl:text> - </xsl:text>
                                                                        <xsl:value-of
                                                                                select="n1:assignedAuthor/n1:code/@displayName" />
                                                                        <xsl:text>, </xsl:text>
                                                                        <xsl:value-of
                                                                                select="n1:assignedAuthor/n1:representedOrganization/n1:name" />
                                                                </xsl:when>
                                                                <xsl:when
                                                                        test="n1:assignedAuthor/n1:assignedAuthoringDevice/n1:manufacturerModelName">
                                                                        <xsl:value-of
                                                                                select="n1:assignedAuthor/n1:assignedAuthoringDevice/n1:manufacturerModelName" />
                                                                        <xsl:if
                                                                                test="n1:assignedAuthor/n1:representedOrganization/n1:name">
                                                                                <xsl:text> at </xsl:text>
                                                                                <xsl:value-of
                                                                                        select="n1:assignedAuthor/n1:representedOrganization/n1:name" />
                                                                        </xsl:if>
                                ...
                                <xsl:for-each
                                        select="/n1:ClinicalDocument/n1:authenticator">
                                        <tr>
                                                <th class="header">
                                                ...
                                                <td class="header">
                                                        <xsl:if
                                                                test="n1:assignedEntity/n1:assignedPerson/n1:name">
                                                                <xsl:call-template
                                                                        name="getName">
                                                                        <xsl:with-param name="name"
                                                                ...
                                                                <xsl:text> - </xsl:text>
                                                                <xsl:value-of
                                                                        select="n1:assignedEntity/n1:code/@displayName" />
                                                        </xsl:if>
                                                        <xsl:text> on </xsl:text>
                                                        <xsl:call-template
                                                                name="formatDate">
                                ...
                                <xsl:for-each
                                        select="/n1:ClinicalDocument/n1:dataEnterer">
                                        <tr>
                                                <th class="header">
                                                ...
                                                <td class="header">
                                                        <xsl:if
                                                                ...
                                                                <!--<xsl:text> 
                                                                        - </xsl:text> <xsl:value-of select="n1:assignedEntity/n1:code/@displayName"/> -->
                                                        </xsl:if>
                                                        <xsl:if
                                                                test="n1:assignedEntity/n1:code">
                                                                <xsl:text> - </xsl:text>
                                                                <xsl:value-of
                                                                        select="n1:assignedEntity/n1:code/@displayName" />
                                                        </xsl:if>
                                                        <xsl:if
                                                                test="n1:assignedEntity/n1:representedOrganization/n1:name">
                                                                <xsl:text> , </xsl:text>
                                                                <xsl:value-of
                                ...
                                <xsl:for-each
                                        select="/n1:ClinicalDocument/n1:authorization">
                                        <xsl:sort
                                                select="@typeCode" />
                                        <tr>
                                                <th class="header"
                                                        ...
                                                        <xsl:choose>
                                                                <xsl:when
                                                                        test="@typeCode='AUTH' and not(preceding-sibling::*/@typeCode='AUTH')">
                                                                        <xsl:choose>
                                                                                <xsl:when
                                                                                        test="count(following-sibling::*[@typeCode='AUTH'])=0">
                                                ...
                                                <td class="header">
                                                        <xsl:value-of
                                                                select="n1:consent/n1:code/@displayName" />
                                                </td>
                                        </tr>
                                </xsl:for-each>
                        </table>
        ...
        <xsl:template name="titlebar">
                <div class="titlebar">
                        ...
                        <table class="titlebar">
                                <xsl:for-each
                                        select="/n1:ClinicalDocument/n1:componentOf">
                                        <xsl:if
                                                test="n1:encompassingEncounter">
                                                <tr>
                                                        <th
                                                                class="titlebar">Encounter
                                                                Type</th>
                                                        <td
                                                                class="titlebar">
                                                                <xsl:value-of
                                                                        select="n1:encompassingEncounter/n1:code/@displayName" />
                                                        </td>
                                                </tr>
                                                <tr>
                                                        <th
                                                        ...
                                                        <td
                                                                ...
                                                                <xsl:choose>
                                                                        <xsl:when
                                                                                test="//n1:encompassingEncounter/n1:effectiveTime/n1:low/@value and //n1:encompassingEncounter/n1:effectiveTime/n1:high/@value">
                                                                                <xsl:call-template name="formatDate">
                                                                                        <xsl:with-param name="date"
                                                                                                select="n1:encompassingEncounter/n1:effectiveTime/n1:low/@value" />
                                                                                </xsl:call-template>
                                                                                <xsl:text> to </xsl:text>
                                                                                <xsl:call-template name="formatDate">
                                                                                        <xsl:with-param name="date"
                                                                                                select="n1:encompassingEncounter/n1:effectiveTime/n1:high/@value" />
                                                                                </xsl:call-template>
                                                                        </xsl:when>
                                                                        <xsl:when
                                                                                test="//n1:encompassingEncounter/n1:effectiveTime/n1:low/@value and not(n1:encompassingEncounter/n1:effectiveTime/n1:high/@value)">
                                                                        ...
                                                                        <xsl:when
                                                                                test="//n1:encompassingEncounter/n1:effectiveTime/n1:high/@value and not(n1:encompassingEncounter/n1:effectiveTime/n1:low/@value)">
                                                                        ...
                                                                        <xsl:when
                                                                                test="//n1:encompassingEncounter/n1:effectiveTime/n1:center/@value">
                                                                                <xsl:call-template name="formatDate">
                                                                                        <xsl:with-param name="date"
                                                                                                select="//n1:encompassingEncounter/n1:effectiveTime/n1:center/@value" />
                                                                                </xsl:call-template>
                                                                        </xsl:when>
                                                                </xsl:choose>
                                                        </td>
                                                </tr>
                                                <!--PRTR1 Encounter identifier 
                                                        check for NHS 111 specific oids -->
                                                <xsl:for-each
                                                        select="/n1:ClinicalDocument/n1:componentOf/n1:encompassingEncounter/n1:id">
                                                        <xsl:choose>
                                                                <xsl:when
                                                                        test="./@root = '2.16.840.1.113883.2.1.3.2.4.18.34'">
                                                                        <tr>
                                                                ...
                                                                <xsl:when
                                                                        test="./@root = '2.16.840.1.113883.2.1.3.2.4.18.35'">
                                                                        <tr>
                                                                ...
                                                                <!--<xsl:when 
                                                                        test="./@root = 'UUID'"> <xsl:text>This is UUID and should not be shown</xsl:text> 
                                                                        </xsl:when> -->
                                                                <xsl:otherwise>
                                                ...
                                                <xsl:if
                                                        test="n1:encompassingEncounter/n1:dischargeDispositionCode/@displayName">
                                                        <tr>
                                                                <th
                                                                        class="titlebar">Encounter
                                                                        Disposition</th>
                                                                <td
                                                                        class="titlebar">
                                                                        <xsl:value-of
                                                                                select="n1:encompassingEncounter/n1:dischargeDispositionCode/@displayName" />
                                                                </td>
                                                        </tr>
                                                </xsl:if>
                                                <xsl:if
                                                        test="n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:serviceProviderOrganization/n1:name">
                                                        <tr>
                                                                <th
                                                                        class="titlebar">Care
                                                                        Setting
                                                                ...
                                                                <td
                                                                        class="titlebar">
                                                                        <xsl:value-of
                                                                                select="n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:serviceProviderOrganization/n1:name" />
                                                                </td>
                                                        </tr>
                                                </xsl:if>
                                                <xsl:if
                                                        test="n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:location/n1:name">
                                                        <tr>
                                                                <th
                                                                        class="titlebar">Care
                                                                        Setting
                                                                ...
                                                                <td
                                                                        class="titlebar">
                                                                        <xsl:value-of
                                                                                select="n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:location/n1:name" />
                                                                </td>
                                                        </tr>
                                                </xsl:if>
                                                <xsl:if
                                                        test="n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:location/n1:addr">
                                                        <tr>
                                                                <th
                                                                        class="titlebar">Care
                                                                        Setting
                                                                ...
                                                                <td
                                                                        class="titlebar">
                                                                        <xsl:for-each
                                                                                select="n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:location/n1:addr">
                                                                                <p class="label">
                                                                                        <xsl:choose>
                                                                                                <xsl:when test="@use='TMP'">
                                                                                                        Temporary
                                                ...
                                                <tr>
                                                        ...
                                                        <td
                                                                class="titlebar">
                                                                <xsl:value-of
                                                                        select="n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:code/@displayName" />
                                                        </td>
                                                </tr>
                                                <xsl:for-each
                                                        select="n1:encompassingEncounter/n1:responsibleParty">
                                                        <tr>
                                                                <th
                                                                        class="titlebar">
                                                                ...
                                                                <td
                                                                        ...
                                                                        <xsl:if test="n1:assignedEntity/n1:assignedPerson/n1:name">
                                                                                ...
                                                                                <xsl:if
                                                                                        test="n1:assignedEntity/n1:representedOrganization/n1:name"> <!--PRTR1 code added to get the org name rendered -->
                                                                                        <xsl:text>, </xsl:text>
                                                                                        <xsl:call-template name="getName">
                                                                                                <xsl:with-param name="name"
                                                                                                        select="n1:assignedEntity/n1:representedOrganization/n1:name" />
                                                ...
                                                <xsl:for-each
                                                        select="n1:encompassingEncounter/n1:encounterParticipant">
                                                        <tr>
                                                                <th
                                                                        class="titlebar">
                                                                        <xsl:choose>
                                ...
                                <!--PRTR1 code commented to take all participants 
                                        under new banner -->
                                <!-- <xsl:for-each select="//n1:ClinicalDocument/n1:participant[@typeCode='REFB']"> 
                                        <tr> <th class="titlebar"> <xsl:text>Referrer</xsl:text> </th> <td class="titlebar"> 
                                        <xsl:if test="n1:associatedEntity/n1:associatedPerson/n1:name"> <xsl:call-template 
                                        name="getName"> <xsl:with-param name="name" select="n1:associatedEntity/n1:associatedPerson/n1:name"/> 
                                        </xsl:call-template> <xsl:if test="n1:associatedEntity/n1:code/@displayName"> 
                                        <xsl:text> - </xsl:text> <xsl:value-of select="n1:associatedEntity/n1:code/@displayName"/> 
                                        </xsl:if> </xsl:if> </td> </tr> <tr> <th class="titlebar"> <xsl:text>Referrering 
                                        Organization</xsl:text> </th> <td class="titlebar"> <xsl:if test="n1:associatedEntity/n1:scopingOrganization/n1:name"> 
                                        <xsl:call-template name="getName"> <xsl:with-param name="name" select="n1:associatedEntity/n1:scopingOrganization/n1:name"/> 
        ...
        <xsl:template name="participantBanner">
                <div id="participantBanner" class="banner">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='IND']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                                        ...
                                        <xsl:if
                                                test="n1:associatedEntity/n1:associatedPerson/n1:name">
                                                <tr>
                                                        <th
                                                                class="header">
                                                        ...
                                                        <td
                                                                ...
                                                                <xsl:if
                                                                        test="n1:associatedEntity/n1:code/@displayName">
                                                                        <xsl:text> - </xsl:text>
                                                                        <xsl:value-of
                                                                                select="n1:associatedEntity/n1:code/@displayName" />
                                                                </xsl:if>
                                                        </td>
                                                </tr>
                                        </xsl:if>
                                ...
                                <xsl:if
                                        test="n1:associatedEntity/n1:addr">
                                        <xsl:call-template
                                                name="participantBody" />
                                </xsl:if>
                        </xsl:for-each>
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='REFB']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='CON']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='REFT']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='BBY']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='REF']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='CALLBCK']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='DEV']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='DIST']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='ELOC']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='NOT']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='VIA']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                        ...
                        <xsl:for-each
                                select="/n1:ClinicalDocument/n1:participant[@typeCode='WIT']">
                                <table>
                                        <tr>
                                                <th
                                                        class="participant">
                ...
                <div class="footer">
                        <table class="header">
                                <tr>
                                        ...
                                        <td class="header">
                                                <xsl:value-of
                                                        select="/n1:ClinicalDocument/n1:id/@root" />
                                        </td>
                                        <th class="header">
                                        ...
                                        <td class="header">
                                                <xsl:value-of
                                                        select="/n1:ClinicalDocument/n1:versionNumber/@value" />
                                        </td>
                                </tr>
                                <!--PRTR1 get replacement of (related document) 
                                        here -->
                                <xsl:if
                                        test="/n1:ClinicalDocument/n1:relatedDocument/@typeCode='RPLC'">
                                        <tr>
                                                <th class="header">
                                                ...
                                                <td class="header">
                                                        <xsl:value-of
                                                                select="/n1:ClinicalDocument/n1:relatedDocument/n1:parentDocument/n1:id/@root" />
                                                </td>
                                                <th class="header">
                                                        <xsl:text>Version</xsl:text>
                                                </th>
                                                <td class="header">
                                                        <xsl:value-of
                                                                select="/n1:ClinicalDocument/n1:relatedDocument/n1:parentDocument/n1:versionNumber/@value" />
                                                </td>
                                        </tr>
                                </xsl:if>
                                <!--PRTR1 get addendum to (related document) 
                                        here -->
                                <xsl:if
                                        test="/n1:ClinicalDocument/n1:relatedDocument/@typeCode='APND'">
                                        <tr>
                                                <th class="header">
                                ...
                                <!--PRTR1 get transformation of (related 
                                        document) here -->
                                <xsl:if
                                        test="/n1:ClinicalDocument/n1:relatedDocument/@typeCode='XFRM'">
                                        <tr>
                                                <th class="header">
                                ...
                                <xsl:for-each
                                        select="n1:informationRecipient">
                                        <xsl:sort
                                                select="@typeCode" />
                                        <tr>
                                                <th class="header"
                                                        ...
                                                        <xsl:choose>
                                                                <xsl:when
                                                                        test="@typeCode='PRCP'and not(preceding-sibling::*/@typeCode='PRCP')">
                                                                        <xsl:choose>
                                                                                <xsl:when
                                                                                        test="count(following-sibling::*[@typeCode='PRCP'])=0">
                                                                ...
                                                                <xsl:when
                                                                        test="@typeCode='TRC'and not(preceding-sibling::*/@typeCode='TRC')">
                                                                        <xsl:choose>
                                                ...
                                                <td class="header">
                                                        ...
                                                        <xsl:if
                                                                test="n1:intendedRecipient/npfitlc:recipientRoleCode/@displayName">
                                                                <xsl:if
                                                                        test="n1:intendedRecipient/n1:informationRecipient/n1:name">
                                                                        <xsl:text> - </xsl:text>
                                                                </xsl:if>
                                                                <xsl:value-of
                                                                        select="n1:intendedRecipient/npfitlc:recipientRoleCode/@displayName" />
                                                        </xsl:if>
                                                        <xsl:if
                                                                test="n1:intendedRecipient/n1:receivedOrganization/n1:name">
                                                                <xsl:if
                                                                        test="n1:intendedRecipient/n1:informationRecipient/n1:name or n1:intendedRecipient/npfitlc:recipientRoleCode/@displayName">
                                                                        <xsl:text>, </xsl:text>
                                                                </xsl:if>
                                                                <xsl:call-template
                                                                        name="getName">
                                                ...
                                                <th class="header">
                                                        <xsl:if
                                                                test="n1:intendedRecipient/n1:telecom">
                                                                <xsl:choose>
                                                                        <xsl:when
                                                                                test="contains(n1:intendedRecipient/n1:telecom/@value, 'mailto')">
                                                                                Email
                                                                        </xsl:when>
                                                                        <xsl:when
                                                                                test="contains(n1:intendedRecipient/n1:telecom/@value, 'tel')">
                                                                                Phone
                                                                        </xsl:when>
                                                                </xsl:choose>
                                                        </xsl:if>
                                                ...
                                                <td class="header">
                                                        <xsl:value-of
                                                                select="substring-after(n1:intendedRecipient/n1:telecom/@value,':')" />
                                                </td>
                                        </tr>
                                </xsl:for-each>
                        </table>
        ...
        <xsl:template name="getContactInfo">
                ...
                <xsl:apply-templates
                        select="$contact/n1:addr" />
                <xsl:apply-templates
                        select="$contact/n1:telecom" />
        </xsl:template>
        <xsl:template match="n1:addr">
                ...
                <xsl:if test="n1:streetName">
                        <xsl:value-of
                                select="n1:streetName" />
                        <xsl:text> </xsl:text>
                        <xsl:value-of
                                select="n1:houseNumber" />
                        <br />
                </xsl:if>
        ...
        <!--PRTR1 This is for Service Event template [0..*] and each service 
                event can have multiple performers [0..*] -->
                ...
                <xsl:for-each select="//n1:documentationOf">
                        <tr>
                                <th class="header" valign="top">
                                        <xsl:choose>
                                                <xsl:when
                                                        test="@typeCode='DOC' and not(preceding-sibling::*/@typeCode='DOC')">
                                                        <xsl:choose>
                                                                <xsl:when
                                                                        test="count(following-sibling::*[@typeCode='DOC'])=0">
                                ...
                                <td class="header">
                                        <xsl:if
                                                test="n1:serviceEvent/n1:code">
                                                <xsl:value-of
                                                        select="n1:serviceEvent/n1:code/@displayName" />
                                        </xsl:if>
                                        <xsl:if
                                                test="n1:serviceEvent/n1:effectiveTime">
                                                <xsl:text> - </xsl:text>
                                                <xsl:text>From </xsl:text>
                                                <xsl:call-template
                                                        name="formatDate">
                                                        <xsl:with-param
                                                                name="date"
                                                                select="n1:serviceEvent/n1:effectiveTime/n1:low/@value" />
                                                </xsl:call-template>
                                                <xsl:text>  To </xsl:text>
                                                <xsl:call-template
                                                        name="formatDate">
                                                        <xsl:with-param
                                                                name="date"
                                                                select="n1:serviceEvent/n1:effectiveTime/n1:high/@value" />
                                                </xsl:call-template>
                                        </xsl:if>
                                        <!--<xsl:if test="n1:serviceEvent/n1:performer/n1:assignedEntity/n1:assignedPerson/n1:name"> 
                                                <xsl:text> , </xsl:text> <xsl:call-template name="getName"> <xsl:with-param 
                                                name="name" select="n1:serviceEvent/n1:performer/n1:assignedEntity/n1:assignedPerson/n1:name"/> 
                                                </xsl:call-template> </xsl:if> -->
                                        <!--</td> -->
                                        <!--PRTR1 Get the performer loop 
                                                here -->
                                        <p>
                                                <xsl:for-each
                                                        select="n1:serviceEvent/n1:performer">
                                                        <xsl:sort
                                                                select="@typeCode" />
                                                        <xsl:choose>
                                                                <xsl:when
                                                                        test="@typeCode='PRF' and not(preceding-sibling::*/@typeCode='PRF')">
                                                                        <xsl:choose>
